...
gantt
  ...
  Lluvia de ideas          :a2, after a1, 2d
  Prototipos               :a3, after a2, 3d
  Inicio informe           :a4, after a1, 1d

  section Sprint 2
  Inicio web               :b1, after a3, 3d
  Informe desarrollo       :b2, after a4, 2d
  Códigos y herramientas   :b3, after b2, 2d

  section Sprint 3
  Finalizar web            :c1, after b1, 15d
  Finalizar informe        :c2, after c1, 5d
  Revisión                 :c3, after c2, 2d
  Feedback                 :c4, after c3, 1d
  Refinamiento             :c5, after c4, 1d
  Lanzamiento              :c6, after c5, 1d
```
