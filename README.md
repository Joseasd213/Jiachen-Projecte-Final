...
gantt```
    ...
    Inicio del informe          :a4, 2026-04-22, 10d

    section Sprint 2: Desarrollo
    Página web (inicio)         :b1, 2026-05-05, 10d
    Desarrollo Raspberry        :b2, 2026-05-05, 10d
    Continuación del informe    :b3, 2026-05-05, 10d

    section Sprint 3: Cierre
    Finalizar página web        :c1, 2026-05-19, 5d
    Finalizar informe           :c2, 2026-05-19, 5d
    Revisión                    :c3, 2026-05-25, 2d
    Feedback docentes           :after c3, 2d
    Refinamiento                :after c3, 2d
    Lanzamiento final           :c6, 2026-05-29, 1d
